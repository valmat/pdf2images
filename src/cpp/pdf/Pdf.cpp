...
namespace {
    ...
    void pagebreaker_simple(std::ofstream& out, size_t) noexcept {}
    void pagebreaker(std::ofstream& out, size_t page_no) noexcept
    {
        out << "========== " << page_no << " ==========\n";
    }
...
namespace pdf {
        ...
        int pages_limit) const
    {
        ...
        
        {
            ...
            remove_form_feed(page_text);
            pagebreaker_f(out, pages_first + 1);
            out << page_text;
